...
A FiveThirtyEight study categorized the content of 233 Super Bowl ads from 10 major companies and tagged them according to whether or not it was funny, showed the product quickly, patriotic, and/or depicting dangerous situations in addition to whether or not it had a celebrity, animals, or sexual imagery.
...
aggregatedCateoryAdsSubset <- aggregate(adsSubset[c("total")], adsSubset[categories], sum)
aggregatedCateoryAdsSubset[order(-aggregatedCateoryAdsSubset$total),]
```

...
```{r}
ads <- read.csv("https://raw.githubusercontent.com/PPPeck313/DATA-607-Assignment-1-Basic-Loading-and-Transformation/908af816819f69a5f53a8a18be522fedeecb31e8/superbowl-ads.csv")
```
